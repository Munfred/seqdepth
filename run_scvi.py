...
# snakemake -j 100 -s run_scvi.py --keep-going --rerun-incomplete --latency-wait 50 --cluster "sbatch -A lpachter -t 500  -o ./logs/output.%a.out "
# snakemake -j 300 -s run_scvi.py --keep-going --rerun-incomplete --latency-wait 50 --cluster "sbatch -A lpachter -t 500   --output=./logs/scvi_%j.scvi"
...
#             os.makedirs(os.path.dirname(out_file))
        ...
        df.to_csv(output.SCVI_PARTIAL_SUMMARY)
